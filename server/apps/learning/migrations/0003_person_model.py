...
_phone_nunber_check = CheckConstraint(
    check=Q(('personal_phone__regex', r'^\d+$',), ('personal_phone', '',), _connector='OR'),
    name='phone_nunber_check'
)

_email_pattern_check = CheckConstraint(
    check=Q(('email__regex', EMAIL_ADDRESS_PATTERN,), ('email', ''), _connector='OR'),
...
class Migration(BaseMigration):
    ...
    operations = (
        ...
        AddConstraint(model_name='person', constraint=_phone_nunber_check),
