...
@mark.django_db
def test_successful_creation(fake_login_credentials) -> None:
...
def test_create_existing_account(fake_account, fake_login_credentials) -> None:
...
def test_username_case_sensitivity_restrictions(
    fake_account, fake_login_credentials
) -> None:
    '''
